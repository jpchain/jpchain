### JPChain is a Global blockchain-powered interconnected API ecosystem provider, connecting all the available Blockchain APIs in one chain and simplifying them for non high tech persons. 
